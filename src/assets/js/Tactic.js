...
export default class Tactic {
	...
	hasCommands () { return this.pool.length > 0; }
	addCommand (com) { return this.pool.add(com); }
	// Simplify creating of command object
	command (name = '', ...params) { return new UnitCommand[name](this.unit, name, ...params); }
	execute () { return this.pool.execute(); }
